...
/**
 * The constant propagator reduces the program complexity by precomputing
 * constant expressions and propagating them.
 * 
 * The ConstantPropagator visitor may change the structure of JAskell-Core
 * tree by eliminating unuseful instructions.
 * 
 * @author bailly
