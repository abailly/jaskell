...
public interface Primitives {
    ...
    DataDefinition DATA_LIST = new PrimitiveData("([])", TypeFactory.makeApplication(LIST, VAR_A), JList.class, Module.PRELUDE);

    ConstructorDefinition CONS = new PrimitiveConstructor("(:)", DATA_LIST, new Type[] {
            VAR_A,
            TypeFactory.makeApplication(LIST, VAR_A)
    ...
    /** primitive functions */
    PrimitiveFunction ERROR = new PrimitiveFunction("error", Module.PRELUDE, TypeFactory.makeApplication(TypeFactory.makeApplication(FUNCTION, STRING), TypeFactory.freshBinding()), null);
