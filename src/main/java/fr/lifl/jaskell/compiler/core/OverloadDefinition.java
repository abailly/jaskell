 ...
 * <p>
 * This class is used to store multiple definitions of a function for 
 * a single name. The various definitions are distinguished by their types. 
 * 
 * @author bailly
...
public class OverloadDefinition extends Definition {
	...
	/**
	 * Adds a new definition for this overloaded function with given type.
	 * If <code>type</code> is null, we assumes that it is not yet known 
	 * and stores the <code>expr</code> part in a waiting list.
	 * 
	 * @param expr
	 * @param type
	 */
	...
	/**
	 * Returns a list of all untyped definitions and remove them from
	 * this definition. It is the responsibility of the caller to
	 * rebind the definitions into this overload definition object
	 * 
	...
	/**
	 * Returns a set view of all definitinos in this 
	 * object, whether typed or untyped
	 * 
	...
	/**
	 * Returns an expression from this overloaded function which
	 * is "compatible" with <code>type</code>.
	 * <p>
	 * This method tries to locate in this object an expression whose type is
	 * the equal to or is the least supertype of the given <code>type</code>. 
	 * 
	 * @param type a type requested
	 * @return an Expression whose type is a super type of requested type. May 
	 * return null if no correct definitino is found
	 */
