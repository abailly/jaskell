...
/**
 * Class representing 'case' expressions.
 * 
 * This class encapsulates an alternative expression, built from :
 * <ul>
...
public class Alternative extends ExpressionBase {
	...
	/** 
	 * Adds a new pattern-expression couple to this alternative. In the 
	 * processe, the local bindings are reindexed starting from 0.
	 *  
	...
	/**
	 * Returns an iterator over all the pattern/expressions
	 * couples in this alternative. The returned Iterator objetc
	...
	/**
	 * Returns an iterator over the set of all
	 * body of choices made in this alternative.
	 * 
