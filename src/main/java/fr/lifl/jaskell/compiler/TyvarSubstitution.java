...
/**
 * A general substitution class for replacing free type variables occuring in an expression This substitution algorithms
 * replaces free type variables in an expression according to a given map.
 *
 * @author  bailly
