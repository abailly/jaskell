...
public abstract class CompilerPass extends JaskellVisitorAdapter {
	...
	/**
	 * Generate a call to <code>error</code> function.
	 * 
	 * This method generates a call to the <code>error</code> 
	 * function yielding a runtime exception with given message.
	 * 
	...
	/**
	 * Method staticPatternMatch. This method  compares a Pattern expression
	 * and a literal expression. If they can be matched, then return true. 
	 * @param p
	 * @param expr
	 * @return boolean
	 */
	 ...
	 * Method tryApply. 
	 * 
	 * Tries to apply the application node to its arguments 
	 * and evaluates its result. This method is must be called with
	 * all arguments from Literal and  functional expression from
	 * Variable.
	 * 
	 * @param a
	 * @return Expression
	...
	protected Expression tryApply(Application a) {
		...
		try {
			...
			System.err.println(
				"Unable to compute value from function " + fname + "::" + t);
			return a;
		}
	}
	 ...
	 * Method packArg. 
	 * 
	 * This method transform a constant object to a Literal expression
	 * 
	 * @param res
	 * @return Expression
	 */
	 ...
	 * Method unpackArgs.
	 * 
	 * This method takes an application spine and converts literal arguments
	 * to an array of Object values.
	 * 
	 * @param a
	 * @return Object[]
	 */
	...
	/**
	 * Method for finding primitive methods in builtin modules : Prelude and PreludeBuiltin
	 *
	 * Returns a method given a function name and arguments
	 * types. The function name is given as a valid Jaskell name (if 
	 * it is an operator, it must be enclosed in parenthesis) and 
	 * the types as valid Jaskell static type.
	 * 
	 ...
	 * Method resolve.
	 * 
	 * Returns a fully qualified name given a simple name
	 * @param string
	 * @return String
	 */
