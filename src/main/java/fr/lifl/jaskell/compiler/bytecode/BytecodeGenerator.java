...
public class BytecodeGenerator extends CompilerPass implements Opcodes {
    ...
    /**
     * Cleanup generated class files by iterating over the current map and calling a ClassFileHandler
     *
     * @param cfh ClassFileHandler
     */
    ...
    /**
     * Method encodeType2Java. Transforms a - function - type into an array of java classes allowing resolution of
     * method.
     *
     * @param  type
     *
    ...
    public static Class[] encodeType2Java(Type type) {
        ...
        while (fti.hasNext()) {
            cur = (Type) fti.next();
            Type dom = ((TypeApplication) ((TypeApplication) cur).getDomain()).getRange();
            l.add(dom.visit(tv));
        }
    ...
    /**
     * Method encodeType2Java. Transforms a - function - type into an array of java classes allowing resolution of
     * method. The return argument is not used.
     *
     * @param  type
     *
     * @return Class[]
    ...
    /**
     * Method encode2java. Transforms a Jaskell function name into a valid java name.
     *
     * @param  fname
     *
     * @return String
