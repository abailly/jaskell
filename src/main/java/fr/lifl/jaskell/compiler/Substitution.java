...
/**
 * A general substitution class for replacing free variables in an expression
 * 
 * This substitution algorithms replaces free variables in an expression according
 * to a given map. Variables occuring hidden beneath a lambda abstraction or a 
 * case construction are not substituted
 * @author bailly
