...
class Yylex {
    ...
    public void yyerror(String msg) {
        ...
        err.append(makePosition().toString()).append(" : ").append(msg);
        ...
        while (true) {
            ...
            if (YY_F != yy_next_state) {
                ...
                if (YY_NO_STATE == yy_last_accept_state) {
                    ...
                    case 50: {
                        yycolumn = yychar;
                        return yylex(); /* single line comments */
                    }
