...
/**
 * Standard functions definitions for Jaskell
 * 
 * This class contains static functions defining primitives Prelude 
 * functions, that is functions which need to be defined in Java, not
 * in Jaskell. Most functions are overloaded. 
 * 
 * @author bailly
...
public class Prelude{
	...
	static private final BufferedReader rdin =
	...
	*/
	 ...
	 * Sequence function.
	 * 
	 * Evaluates both arguments one after another and
